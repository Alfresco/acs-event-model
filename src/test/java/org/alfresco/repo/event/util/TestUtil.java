...
public class TestUtil
{
    ...
    public static final ValueMatcher<Object> UUID_VALUE_MATCHER = (o1, o2) -> {
        // In case, expected json and actual json are both having null, then they are equal
        // direct comparison with null will throw NullPointerException or both fields being unequal even when they are equal
